  ...
  return (
    <div className="bg-white rounded-xl shadow-sm p-4 border border-gray-100">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-center">
        <div className={`rounded-lg border border-dashed border-gray-300 h-48 flex items-center justify-center ${loading ? 'bg-gray-100 animate-pulse' : 'bg-gray-100'}`}>
          <FaChartPie className="text-gray-600 mr-2" aria-hidden="true" />
          <span className="text-gray-700 text-sm">Gráfico de dona preparado para integrar librería</span>
        </div>
