...
const LoadingOverlay = ({ visible = false, text = 'Procesando...' }) => {
  if (!visible) return null
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-30 backdrop-blur-sm">
      <div className="flex items-center gap-3 bg-white rounded-xl px-6 py-4 shadow-lg border border-gray-100">
